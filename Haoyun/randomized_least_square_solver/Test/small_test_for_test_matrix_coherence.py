...
t1_low = perf_counter()
x1_low, iternum1_low, flag1_low, _ = LSRN_over(A_low, b_low, tol=1e-14)
...
print("\tRelative Residual Error:", norm(t2_low) / norm(b_low))
...
x1_medium, iternum1_medium, flag1_medium, _ = LSRN_over(A_medium, b_medium, tol=1e-14)
...
print("\tRelative Residual Error:", norm(t2_medium) / norm(b_medium))
...
x1_high, iternum1_high, flag1_high, _ = LSRN_over(A_high, b_high, tol=1e-14)
