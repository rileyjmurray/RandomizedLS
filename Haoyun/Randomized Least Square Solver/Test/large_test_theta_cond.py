...
cond_num_list = 10 ** np.linspace(0, 16, 9)
theta_list = 2 ** (-np.linspace(54, 1, 9))
...
sns.heatmap(np.log10(Naive_LSQR_iternum_matrix), xticklabels=-np.linspace(54, 1, 9),
...
# log10(condition number) ranges from 1 to 6 and theta ranges from pi/2 * 2^[0, -5].
sns.heatmap(np.log10(LSRN_iternum_matrix), xticklabels=-np.linspace(54, 1, 9),
            yticklabels=np.log10(cond_num_list))
...
# log10(condition number) ranges from 1 to 6 and theta ranges from pi/2 * 2^[0, -5].
sns.heatmap(np.log10(Riley_Blen_iternum_matrix), xticklabels=-np.linspace(54, 1, 9),
            yticklabels=np.log10(cond_num_list))
...
# log10(condition number) ranges from 1 to 6 and theta ranges from pi/2 * 2^[0, -5].
sns.heatmap(np.log10(Naive_LSQR_normal_equation_error_matrix), xticklabels=-np.linspace(54, 1, 9),
            yticklabels=np.log10(cond_num_list))
...
# log10(condition number) ranges from 1 to 6 and theta ranges from pi/2 * 2^[0, -5].
sns.heatmap(np.log10(LSRN_normal_equation_error_matrix), xticklabels=-np.linspace(54, 1, 9),
            yticklabels=np.log10(cond_num_list))
...
# log10(condition number) ranges from 1 to 6 and theta ranges from pi/2 * 2^[0, -5].
sns.heatmap(np.log10(Riley_Blen_normal_equation_error_matrix), xticklabels=-np.linspace(54, 1, 9),
            yticklabels=np.log10(cond_num_list))
...
# plt.title('Iteration Number of 6000 * 300 Randomized Matrices(Theta pi/4)')
...
# plt.plot(-np.linspace(54, 1, 9), Naive_LSQR_iternum_matrix[-1, :], 'g:', label='Naive LSQR')
# plt.plot(-np.linspace(54, 1, 9), Riley_Blen_iternum_matrix[-1, :], 'b', label='Riley Blendenpik')
# plt.plot(-np.linspace(54, 1, 9), LSRN_iternum_matrix[-1, :], 'k-.', label='LSRN')
# plt.xlabel('log2(theta)')
# plt.ylabel('Iteration Number')
...
# plt.title('Normal Equation Error of 6000 * 300 Randomized Matrices(Theta pi/4)')
# plt.legend(loc='best', shadow=True)
...
#
# # plt.plot(m_div_100_list, Blendenpik_iternum_list,'r--', label = 'My Blendenpik')
# plt.plot(-np.linspace(1, 54, 6), np.log10(Naive_LSQR_normal_equation_error_matrix[-1, :]), 'g:', label='Naive LSQR')
# plt.plot(-np.linspace(1, 54, 6), np.log10(Riley_Blen_normal_equation_error_matrix[-1, :]), 'b', label='Riley Blendenpik')
# plt.plot(-np.linspace(1, 54, 6), np.log10(LSRN_normal_equation_error_matrix[-1, :]), 'k-.', label='LSRN')
# plt.xlabel('log2(theta)')
# plt.ylabel('log10(normal equation error)')
